        ...
        <div className="container mx-auto flex items-center justify-between p-4">
          ...
          <nav className="hidden md:flex space-x-4">
            ...
            <div className="relative group">
              <button className="text-gray-600 text-xl font-semibold hover:text-pink-500 p-2">
                Pages
              </button>
          ...
          {menuOpen && (
            <nav className="absolute top-full left-0 w-full bg-white shadow-md md:hidden">
              <a
                href="#"
                className="block text-gray-600 text-xl font-semibold p-4 hover:bg-pink-500 hover:text-white"
              >
                Home
              </a>
              <a
      ...
      <section className="hero-section text-center py-20 bg-gray-50">
        <div className="container mx-auto flex flex-col-reverse md:flex-row items-center">
          <div className="md:w-1/2 text-left p-4">
            ...
            <a
              href="#"
              className="px-8 py-3 border font-semibold border-pink-500 text-pink-500 rounded-full hover:bg-pink-600 hover:text-white"
            >
              Get Started
            </a>
          </div>
