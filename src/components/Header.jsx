...
const HomePage = () => {
    // Intersection Observer hooks for each element
            ...
            <header className="bg-white shadow-sm">
                <div className="container mx-auto flex items-center p-4">
                    ...
                    <nav className="flex space-x-4 ml-72 mr-0">
                        ...
                        <a href="#" className="text-gray-600 text-xl font-semibold hover:text-pink-500 p-2">About</a>
                        <a href="#" className="text-gray-600 text-xl font-semibold hover:text-pink-500 p-2">Services</a>
                        <div className="relative group">
                            ...
                            <div className="absolute hidden group-hover:block bg-white shadow-md mt-2 rounded">
                                <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-pink-500 hover:text-white">Page 1</a>
                                <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-pink-500 hover:text-white">Page 2</a>
                            </div>
                        </div>
                        <a href="#" className="text-gray-600 text-xl font-semibold hover:text-pink-500 p-2">Contact Us</a>
                    </nav>
